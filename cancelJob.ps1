...
Write-GHWarning "Workflow was cancelled - the running scan execution (ID: $global:scanId) was stopped on the AppScan server."
Add-GHSummary "## :grey_exclamation: Scan cancelled`n"
Add-GHSummary "The workflow was cancelled, so the scan execution ``$global:scanId`` was stopped on the AppScan server.`n"
